...
const getOldDatas = () => {
    ...
    const old_seasons =
        props.interest_point.open_seasons === 'Toutes'
            ? ['Printemps', 'Eté', 'Automne', 'Hiver']
            : split(props.interest_point.open_seasons, ',')
...
const nextStep = () => {
    switch (step.value) {
        ...
        case 2:
            ...
            if (form.errors.tag_id === '' && form.errors.seasons === '') {
                step.value++
            }
            break
        ...
        <section v-if="step === 3">
            <div>
                ...
                <BaseMap
                    ...
                    :center-view="[
                        props.interest_point.location.latitude,
                        props.interest_point.location.longitude,
                    ]"
