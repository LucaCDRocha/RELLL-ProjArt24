    ...
    <form @submit.prevent="submit">
        ...
        <section v-if="step == 1">
            <div>
                <InputLabel
                    for="name"
                    value="Veuillez choisir le nom du sentier"
                />
                <TextInput
                    id="name"
            ...
            <div>
                <InputLabel
                    for="description"
                    value="Veuillez mettre une description du sentier"
                />
                <BaseTextArea
                    id="description"
                    class="mt-1 block w-full"
            ...
            <div>
                <InputLabel
                    for="difficulty"
                    value="Veuillez mettre le niveau du sentier"
                />
                <BaseSelect
                    name="difficulty"
        ...
        <section v-if="step == 3">
            ...
            <div>
                <InputLabel
                    for="theme"
                    value="Veuillez indiquer le thème du sentier"
                />
                <BaseSelect
                    name="theme"
                    :options="themesMap"
